...
export default function Home() {
  ...
  React.useEffect(() => {
    if (isMobile) {
      ...
      // Enhanced mobile date picker handling
      const enhanceMobileDatePicker = () => {
        ...
        // Add scroll listener to close date picker
        const handleScroll = () => {
        ...
        // Improve date picker interaction
        document.addEventListener('click', (e) => {
          const datePickerDay = e.target.closest('.react-datepicker__day');
          if (datePickerDay && !datePickerDay.classList.contains('react-datepicker__day--disabled')) {
      ...
      const cleanup = enhanceMobileDatePicker();
      return () => {
        cleanup();
      };
    }
              ...
              <div className="relative mb-4">
                <DatePicker
                  ...
                  onChange={(date) => {
                    ...
                    // Immediately close calendar and move focus after selection
                  ...
                  calendarClassName="bg-white shadow-lg rounded-lg mobile-calendar"
          ...
          <div className="flex justify-center gap-12">
            ...
            >
              <svg className="w-12 h-12 mx-auto mb-2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M12 0C5.4 0 0 5.4 0 12s5.4 12 12 12 12-5.4 12-12-5.4-12-12-12zm0 22C6.5 22 2 17.5 2 12S6.5 2 12 2s10 4.5 10 10-4.5 10-10 10z" 
